...
public class StickyHeaderAdapter<Item extends IItem> extends RecyclerView.Adapter implements StickyRecyclerHeadersAdapter {
    ...
    public long getHeaderId(int position) {
        ...
        if (item instanceof ItemDaerah && ((ItemDaerah) item).header != null) {
            return ((ItemDaerah) item).header.charAt(0);
        }
        return -1;
    }
    ...
    public void onBindHeaderViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        if (item instanceof ItemDaerah && ((ItemDaerah) item).header != null) {
            ...
            textView.setText(String.valueOf(((ItemDaerah) item).header.charAt(0)));
        }
    }
