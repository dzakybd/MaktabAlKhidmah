...
public class ItemDaerah extends RealmObject implements IItem<ItemDaerah, ItemDaerah.ViewHolder> {
    ...
    public ItemDaerah withHeader(String header) {
        this.header = header;
        return this;
    }

    public ItemDaerah create(String namadaerah, String keterangan) {
        this.namadaerah = namadaerah;
        this.keterangan = keterangan;
        return this;
    }

     public ItemDaerah withIdentifier(long daerahid) {
    ...
    public ItemDaerah withTag(Object object) {
        this.mTag = object;
        return this;
    }
   ...
   @Override
    ...
    protected boolean mEnabled = true;
     ...
     public ItemDaerah withEnabled(boolean enabled) {
    ...
    @Override
    public ItemDaerah withSetSelected(boolean selected) {
    ...
    @Override
    public ItemDaerah withSelectable(boolean selectable) {
